...
const articlePlan = [
  ...
  ["Best Hot Sauce Challenge Set Features to Compare", "best-hot-sauce-challenge-set-features", "2026-07-06", "Hot Sauce Challenge Sets", images.challenge, ["hot sauce challenge set", "mild to wild hot sauce", "hot sauce gift set"]],
  ["Ghost Pepper vs Carolina Reaper: What Buyers Should Know", "ghost-pepper-vs-carolina-reaper", "2026-07-07", "Superhot Sauces", images.superhot, ["ghost pepper sauce", "Carolina Reaper sauce", "superhot hot sauce"]],
  ["How to Read Scoville Ratings Without Getting Fooled", "how-to-read-scoville-ratings", "2026-07-08", "Superhot Sauces", images.superhot, ["Scoville scale hot sauce", "pepper heat scale", "hot sauce heat levels"]],
  ...
  ["How to Run a Spicy Noodle Flight", "how-to-run-a-spicy-noodle-flight", "2026-07-10", "Spicy Ramen", images.ramenVariety, ["spicy ramen challenge", "spicy noodle flight", "ramen tasting party"]],
  ...
  ["Chili Crisp vs Hot Sauce", "chili-crisp-vs-hot-sauce", "2026-07-14", "Chili Crisp and Oils", images.chiliJar, ["chili crisp vs hot sauce", "spicy condiment", "chili oil"]],
  ...
  ["Capsaicin Safety for Spicy Food Fans", "capsaicin-safety-for-spicy-food-fans", "2026-07-21", "Safety and Hosting", images.tasting, ["capsaicin safety", "hot sauce challenge safety", "spicy food reaction"]],
  ["What to Serve With Hot Sauce Flights", "what-to-serve-with-hot-sauce-flights", "2026-07-22", "Safety and Hosting", images.tasting, ["hot sauce tasting foods", "hot sauce flight pairings", "spicy challenge recovery"]],
  ["Mild to Wild Hot Sauce Gifts", "mild-to-wild-hot-sauce-gifts", "2026-07-23", "Hot Sauce Challenge Sets", images.challenge, ["mild to wild hot sauce", "hot sauce gift set", "spicy gifts"]],
  ["Best Spicy Gifts for Heat Seekers", "best-spicy-gifts-for-heat-seekers", "2026-07-24", "Hot Sauce Challenge Sets", images.sauceGift, ["spicy gifts", "hot sauce gift set", "spicy ramen gift"]],
  ["Hot Sauce Gift Set Labels: What to Verify", "hot-sauce-gift-set-labels", "2026-07-27", "Hot Sauce Challenge Sets", images.sauceGift, ["hot sauce gift set", "hot sauce ingredients", "hot sauce label"]],
  ["Beginner Hot Sauce Flight Before Superhots", "beginner-hot-sauce-flight-before-superhots", "2026-07-28", "Superhot Sauces", images.superhot, ["beginner hot sauce", "hot sauce flight", "superhot sauce beginner"]],
  ["Chili Oil Storage and Serving Tips", "chili-oil-storage-and-serving-tips", "2026-07-29", "Chili Crisp and Oils", images.chiliJar, ["chili oil storage", "chili crisp serving", "spicy chili oil"]],
  ...
  ["How to Build a Heat Ladder for Friends", "how-to-build-a-heat-ladder-for-friends", "2026-07-31", "Safety and Hosting", images.challenge, ["heat ladder", "hot sauce tasting party", "mild to wild hot sauce"]],
  ["Extreme Hot Sauce Red Flags", "extreme-hot-sauce-red-flags", "2026-08-03", "Superhot Sauces", images.superhot, ["extreme hot sauce", "hot sauce challenge safety", "superhot hot sauce"]],
] as const;
...
export function getNextScheduledArticle(now = new Date()) {
  return resourceArticles
    ...
    .sort((a, b) => new Date(getArticlePublishTime(a)).getTime() - new Date(getArticlePublishTime(b)).getTime())[0];
}
