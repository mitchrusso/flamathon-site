...
export const approvedResourceArticles: ResourceArticle[] = [
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": [
          {
            "text": "Relevant starting points include FDA food allergen guidance and USDA food safety guidance. Official pages can change, and their general guidance does not replace product-specific instructions or individualized professional advice.",
            "sourceIds": [
              "poison-control-capsaicin",
              "fda-food-allergies",
              "cdc-food-safety"
          ...
          {
            "text": "Ingredients, allergen exposure, and heat tolerance differ by person and product. Read the current label, avoid cross-contact, start with a small amount, and seek professional guidance for known allergies or concerning symptoms.",
            "sourceIds": [
              "poison-control-capsaicin",
              "fda-food-allergies",
              "cdc-food-safety"
      ...
      },
      {
        ...
        "body": [
          ...
          {
            "text": "For a broader starting point, visit the Flameathon resource library and use the related decision guides to move to the next situation rather than repeating the same search.",
            "sourceIds": [
              "poison-control-capsaicin",
              "fda-food-allergies",
              "cdc-food-safety"
  ...
  {
    "title": "Hot Sauce Tasting Party: Build a Flavor-First Heat Ladder",
    "slug": "hot-sauce-tasting-party-flavor-heat-ladder",
    ...
    "keywords": [
      ...
      "hot sauce heat ladder",
      "spicy food tasting safety"
    ],
    "table": {
      "caption": "A five-round flavor-first tasting progression",
      "columns": [
        "Round",
        "Host cue",
        "Portion and pause"
      ...
      "rows": [
        [
          "Aromatic",
          "Identify pepper, acid, fruit, smoke, or spice",
          "One drop; discuss flavor before heat"
        ],
        [
          "Mild",
          "Compare texture and salt balance",
          "Small dab; pause several minutes"
        ],
        [
          "Medium",
          "Check comfort and label again",
          "Tiny bite with plain food"
        ],
        [
          "Hot",
          "Invite a fresh opt-in",
          "One product only; longer pause"
        ],
        [
          "Extreme",
          "Usually omit; never make it a dare",
          "Only informed adults may choose to proceed"
        ]
      ]
    },
    "sections": [
      {
        ...
        "body": [
          {
            "text": "A good hot sauce tasting party is a guided flavor flight, not an endurance contest. Choose four or five sauces with different flavor profiles, arrange them from mild to hot using manufacturer information, serve tiny measured portions on plain food, pause between rounds, and let every guest opt out without explanation.",
            "sourceIds": [
              "poison-control-capsaicin",
              "datassential-spicy"
            ]
          ...
          {
            "text": "Before serving, retain every original label and ask guests about the nine major food allergens. Do not rely on color, pepper name, or a host’s tolerance to predict another person’s response. This guide is educational and not medical advice; people with health concerns should consult an appropriate clinician.",
            "sourceIds": [
              "fda-food-allergies",
              "fsis-big-nine",
              "fda-sesame"
      ...
      {
        "heading": "Choose sauces for contrast, not punishment",
        "body": [
          {
            "text": "Build the flight around flavor families: bright vinegar, roasted pepper, fruit-forward, smoky, fermented, herbal, or savory. A ladder is more interesting when each step changes both flavor and perceived heat. Five nearly identical superhot sauces teach guests very little and make portion control harder.",
            "sourceIds": [
              "datassential-spicy",
              "imarc-hot-sauce"
            ]
          ...
          {
            "text": "Treat Scoville claims as rough context, not a promise about the experience. Product formulation, serving size, food pairing, and individual sensitivity all matter. Use the maker’s current label and serving guidance, and omit products marketed primarily as challenges or containing highly concentrated capsaicin unless the gathering and participants are specifically equipped for them.",
            "sourceIds": [
              "pepper-joe-scoville",
              "poison-control-capsaicin",
              "nationwide-one-chip"
      ...
      {
        "heading": "Create an allergen and ingredient station",
        "body": [
          {
            "text": "Place the original bottle beside each tasting cup and provide a printed card with product name, ingredients, declared allergens, heat position, and a clean utensil. Common sauce or pairing ingredients may include milk, egg, soy, wheat, sesame, peanuts, tree nuts, fish, or shellfish.",
            "sourceIds": [
              "fda-food-allergies",
              "fsis-big-nine",
              "fda-sesame"
          ...
          {
            "text": "Do not promise an allergen-free experience unless the entire sourcing, kitchen, equipment, and service process supports that statement. Cross-contact can occur through spoons, cutting boards, fryer oil, gloves, shared bottles, and guests returning used utensils to the table.",
            "sourceIds": [
              "fda-food-allergies",
              "foodsafety-four-steps"
            ]
          }
        ]
      },
      {
        "heading": "Prepare the food safely",
        "body": [
          {
            "text": "Use bite-size portions on neutral foods such as plain rice, bread, potato, or properly cooked protein, while accommodating dietary needs. Follow the standard clean, separate, cook, and chill steps: wash hands and surfaces, keep raw foods apart, cook to safe temperatures, and refrigerate perishables promptly.",
            "sourceIds": [
              "cdc-food-safety",
              "foodsafety-four-steps"
            ]
          ...
          {
            "text": "Assign one server or use single-use droppers so guests do not touch bottle openings. Keep sauces requiring refrigeration cold until service, note open dates, and discard food that has been held outside safe conditions. Capsaicin does not make unsafe food safe.",
            "sourceIds": [
              "cdc-food-safety",
              "foodsafety-four-steps"
            ]
      ...
      {
        "heading": "Set the room before guests arrive",
        "body": [
          {
            "text": "Provide water for hydration, plain food, napkins, handwashing access, and a clearly marked disposal area. Dairy may reduce the sensation for some people, but it is not suitable for every guest and should not be framed as an antidote. Avoid touching eyes and contact lenses after handling sauce; use gloves for concentrated or superhot products.",
            "sourceIds": [
              "poison-control-capsaicin",
              "fda-food-allergies"
            ]
          ...
          {
            "text": "Keep children and pets away from the serving and cleanup area. Do not combine the tasting with speed rules, alcohol pressure, surprise ingredients, prizes for finishing, or social penalties for stopping. Consent should be renewed at every hotter round.",
            "sourceIds": [
              "nationwide-one-chip",
              "poison-control-capsaicin"
            ]
      ...
      {
        "heading": "Host each round with a pause",
        "body": [
          {
            "text": "Introduce the sauce, read the relevant label, serve one measured taste, and ask guests to describe aroma and flavor before discussing heat. Wait several minutes before offering the next round. The delay lets participants notice their response and keeps the group from stacking portions faster than discomfort develops.",
            "sourceIds": [
              "poison-control-capsaicin",
              "pepper-joe-scoville"
            ]
          ...
          {
            "text": "Use a simple 0-to-5 personal comfort scale rather than asking who is toughest. Zero means no heat, three means enjoyable but clearly hot, and five means stop. The scale is not comparable between people; it is a communication tool for each guest.",
            "sourceIds": [
              "poison-control-capsaicin"
            ]
          }
      ...
      {
        "heading": "Know when the tasting is over",
        "body": [
          {
            "text": "Stop serving a participant who reports severe or escalating symptoms. Chest pain, trouble breathing, fainting, confusion, persistent vomiting, or other concerning symptoms warrant prompt medical evaluation; call emergency services for life-threatening symptoms. Contact Poison Control in the United States at 1-800-222-1222 for exposure guidance.",
            "sourceIds": [
              "poison-control-capsaicin",
              "nationwide-one-chip"
            ]
          ...
          {
            "text": "After the event, cap and refrigerate products as their labels require, clean surfaces and utensils, wash hands, and record which flavor combinations guests actually enjoyed. The most useful outcome is a shortlist people want to cook with again—not a photograph of someone in distress.",
            "sourceIds": [
              "cdc-food-safety",
              "foodsafety-four-steps"
            ]
      ...
      {
        "heading": "A host checklist worth reusing",
        "body": [
          {
            "text": "Confirm participants, dietary restrictions, original labels, serving order, portion tools, food temperatures, cross-contact controls, handwashing, relief foods, child and pet boundaries, and an emergency contact plan. Put one person in charge of service so the ladder does not become a free-pour table.",
            "sourceIds": [
              "fda-food-allergies",
              "cdc-food-safety",
              "poison-control-capsaicin"
          ...
          {
            "text": "End with tasting notes: flavor, best pairing, comfortable heat, and whether the sauce belongs in cooking, at the table, or not in the group’s rotation. That turns novelty into a genuinely useful guide for the next meal.",
            "sourceIds": [
              "datassential-spicy"
            ]
          }
      ...
      {
        "heading": "Design pairings that reveal flavor",
        "body": [
          {
            "text": "Use the same neutral base across a comparison when you want to isolate sauce differences, then add a second pairing that shows intended use. A fruit-forward sauce might be compared on rice and roasted vegetables; a smoky sauce might be tried on a properly cooked protein and a plant-based alternative.",
            "sourceIds": [
              "datassential-spicy",
              "foodsafety-four-steps"
            ]
          ...
          {
            "text": "Keep portions independent. Guests should not have to eat a large wing, noodle bowl, or spoonful to sample one sauce. Separate utensils and clearly labeled plates also reduce accidental cross-contact and prevent a hotter sauce from contaminating later bites.",
            "sourceIds": [
              "fda-food-allergies",
              "fsis-big-nine"
            ]
          ...
          {
            "text": "Offer a written scorecard for aroma, flavor, texture, comfortable heat, best pairing, and would-use-again. Avoid declaring a universal winner. A sauce that overwhelms one guest may be balanced for another, and a lower-heat product can be the better cooking tool.",
            "sourceIds": [
              "pepper-joe-scoville",
              "datassential-spicy"
            ]
      ...
      {
        "heading": "Handle leftovers and cleanup deliberately",
        "body": [
          {
            "text": "Return refrigerated products and perishable foods promptly, following label instructions and current food-safety guidance. Do not pour served sauce back into the original bottle. Discard tasting portions and food that may have been contaminated by used utensils or unsafe holding time.",
            "sourceIds": [
              "cdc-food-safety",
              "foodsafety-four-steps"
            ]
          ...
          {
            "text": "Wash reusable utensils and surfaces with appropriate cleaning practices, remove gloves without touching the contaminated exterior, and wash hands before touching eyes, phones, children, or pets. Clean door handles and shared condiment areas if gloved hands contacted them.",
            "sourceIds": [
              "foodsafety-four-steps",
              "poison-control-capsaicin"
            ]
  ...
  },
  {
    ...
    "category": "Spicy Sauces",
    "image": "/images/hot-sauce-label-checklist-allergens-sodium-and-serving-size.svg",
    ...
    "sections": [
      {
        ...
        "body": [
          ...
          {
            "text": "This guide is for a reader who has a real hot sauce label checklist: allergens, sodium, and serving size decision in front of them. It focuses on the sequence, evidence, and recovery path—not on claiming that one answer fits every material, person, location, organization, or appetite.",
            "sourceIds": [
              "poison-control-capsaicin",
              "fda-food-allergies",
              "cdc-food-safety"
      ...
      },
      {
        ...
        "body": [
          ...
          {
            "text": "For this checkpoint, photograph the full label before serving. Observe the real condition rather than the ideal one. A practical record includes product, ingredients, amount, food pairing, storage condition, and guest feedback. If one of those details is unavailable, note the consequence of guessing before continuing.",
            "sourceIds": [
              "poison-control-capsaicin",
              "fda-food-allergies",
              "cdc-food-safety"
          ...
          {
            "text": "Ask what would make this action wrong in the present setting, then identify major allergens and cross-contact warnings. Compare the answer with the complete ingredient label, serving size, preparation method, storage history, and each guest’s stated limits. This counter-check is especially valuable when a familiar method is being reused with a different person, product, location, or workload.",
            "sourceIds": [
              "poison-control-capsaicin",
              "fda-food-allergies",
              "cdc-food-safety"
          ...
          {
            "text": "Use a two-person check when the consequence is meaningful. One person should normalize sodium and serving size for a fair comparison; the other should compare the action with the complete ingredient label, serving size, preparation method, storage history, and each guest’s stated limits. The second check is not bureaucracy—it catches a mismatch while the work is still reversible.",
            "sourceIds": [
              "poison-control-capsaicin",
              "fda-food-allergies",
              "cdc-food-safety"
          ...
          {
            "text": "For this checkpoint, record reactions and stop when tolerance or ingredient certainty changes. Observe the real condition rather than the ideal one. A practical record includes product, ingredients, amount, food pairing, storage condition, and guest feedback. If one of those details is unavailable, note the consequence of guessing before continuing.",
            "sourceIds": [
              "poison-control-capsaicin",
              "fda-food-allergies",
              "cdc-food-safety"
  ...
  },
  {
    ...
    "category": "Spicy Sauces",
    "image": "/images/chili-crisp-storage-after-opening.svg",
  ...
  },
  {
    ...
    "category": "Spicy Sauces",
    "image": "/images/spicy-ramen-flight-portion-label-and-timing-plan.svg",
  ...
  },
  {
    ...
    "seoTitle": "Ghost Pepper Sauce: Cooking and Serving With Care",
    ...
    "sections": [
      {
        ...
        "body": [
          {
            "text": "Treat ghost pepper sauce as an optional seasoning to evaluate in a small separate portion. Read the label first, keep the main dish mild until you know what works, and let every diner decline the heat. One drop is a cautious handling idea, not a universal safe dose: sauces differ in concentration, ingredients, and how easily the bottle pours.",
            "sourceIds": []
          }
        ]
      },
      {
        "heading": "At a glance: TL;DR before opening the bottle",
        "body": [
          {
            "text": "Use a clean utensil to add a very small amount to a separate portion, mix thoroughly, and let a willing adult decide whether to taste it. Never require participation, make a heat challenge part of dinner, or hide the sauce in shared food. Protect skin and eyes, ventilate preparation, check allergens, and keep a clearly labeled mild alternative. Stop if the sauce causes distress or the meal becomes difficult to handle comfortably.",
            "sourceIds": []
          }
        ]
      },
      {
        "heading": "Read more than the pepper name",
        "body": [
          {
            "text": "“Ghost pepper” identifies an ingredient or flavor theme, not a standardized recipe. Examine the ingredient list, serving information, storage directions, and any manufacturer warnings. Some products include other peppers or concentrated ingredients. A familiar name on the front does not tell you that two bottles will behave the same way in a recipe.",
            "sourceIds": []
          },
          {
            "text": "Check the cap and pouring opening before holding the bottle over food. A wide opening or thick sauce can release more than intended. Put a small amount onto a clean measuring utensil away from the main pot instead of shaking the bottle directly into the meal. Keep the label available so guests can review it themselves.",
            "sourceIds": []
          }
        ]
      },
      {
        "heading": "Set up a separate tasting portion",
        "body": [
          {
            "text": "Finish the base dish without the ghost pepper sauce. Transfer a small portion to a separate bowl using a clean utensil. Add a minimal amount of sauce according to the product's directions, stir thoroughly, and keep this bowl distinct from the shared food. If the product warns against ordinary direct consumption or use in the proposed way, choose a different seasoning.",
            "sourceIds": []
          },
          {
            "text": "Let the sample reach a comfortable eating temperature before a willing adult evaluates it. A very hot dish can make the tasting process harder to judge. There is no need to taste repeatedly or increase the amount to prove tolerance. If the first portion is unpleasant, use the mild meal and leave the sauce aside.",
            "sourceIds": []
          }
        ]
      },
      {
        "heading": "Scale by the dish, not by bravado",
        "body": [
          {
            "text": "A successful sample is information about that sample, not a guarantee for the whole pot or every diner. The sauce may not distribute evenly, and people differ in preference and tolerance. For shared meals, serving the sauce separately is often simpler than trying to find one heat level that suits everyone.",
            "sourceIds": []
          },
          {
            "text": "If you choose to season a larger batch, write down the amount of food and the small amount added, mix carefully, and pause before considering more. The record helps you reproduce a preferred flavor later. Do not treat the calculation as a medical safety limit or assume that doubling the food always makes a distressing sauce experience acceptable.",
            "sourceIds": []
          }
        ]
      },
      {
        "heading": "Match the sauce to the cooking stage",
        "body": [
          {
            "text": "Consider whether the sauce is intended as a finishing condiment or a cooking ingredient. Follow its instructions and those of the recipe. Avoid improvised high-heat experiments with an unfamiliar concentrated product. Keep your face away from rising steam and provide ventilation when preparing hot peppers or spicy sauces.",
            "sourceIds": []
          },
          {
            "text": "Capsaicin can irritate skin, eyes, the digestive tract, and the airways. Poison Control's capsaicin guidance recommends gloves when handling hot peppers and avoiding contact with the face and eyes. If preparation causes coughing or discomfort, stop and move away from the exposure rather than pushing through to finish the recipe.",
            "sourceIds": [
      ...
      {
        "heading": "Use a serving decision table",
        "body": [
          {
            "text": "These are hosting choices, not a protocol for making extreme spice consumption safe. The purpose is a meal people can enjoy voluntarily, with enough information to decide what they want.",
            "sourceIds": []
          }
        ]
      },
      {
        "heading": "Keep allergens and heat as separate questions",
        "body": [
          {
            "text": "A mild dish can contain an allergen, and a hot sauce can contain ingredients that are unrelated to capsaicin. Ask guests what information they need, read the complete label, and do not describe a sauce as allergy-safe because it is vegan, homemade, or mostly peppers. Check labels again when opening a replacement bottle because formulations can change.",
            "sourceIds": []
          },
          {
            "text": "Use separate utensils and avoid touching the mild portion with the spoon used for the sauce. A separate bowl does not by itself resolve cross-contact concerns for a person with a food allergy. The FDA's food allergy information explains allergen labeling and why accurate ingredient information matters. Let the affected person make an informed choice and avoid guessing on their behalf.",
            "sourceIds": [
              "editorial-645eb18630e65b"
            ]
          }
        ]
      },
      {
        "heading": "Do not let the spice distract from food safety",
        "body": [
          {
            "text": "Handle the base meal using ordinary food-safety practices: clean preparation surfaces, separate raw and ready-to-eat foods, use appropriate cooking temperatures, and refrigerate perishables promptly. Pepper heat is not evidence that a dish is free of harmful microorganisms. Follow storage directions on commercial sauce and use tested guidance for homemade preparations rather than assuming acidity or spiciness makes them shelf-stable.",
            "sourceIds": []
          },
          {
            "text": "The FoodSafety.gov four-step guidance provides the clean, separate, cook, and chill framework. Plan serving time and leftover storage before guests arrive. Keep the original sauce label with the bottle and label any prepared food so a later diner knows that ghost pepper sauce was added.",
            "sourceIds": [
      ...
      {
        "heading": "Prepare for an uncomfortable exposure",
        "body": [
          {
            "text": "Stop eating or handling the product if it causes distress. Do not turn relief into another challenge or offer unverified remedies as a substitute for professional advice. Keep the bottle available so an exposure specialist can identify the ingredients and concentration information on the label.",
            "sourceIds": []
          },
          {
            "text": "In the United States, Poison Control can provide guidance at 1-800-222-1222. Breathing difficulty or chest discomfort requires emergency attention; Poison Control advises calling 911 for those symptoms. Follow professional instructions for skin or eye exposure rather than experimenting with substances around the eyes. Capsaicin exposure guidance",
            "sourceIds": [
              "editorial-9da7830d173e02"
            ]
          }
      ...
      {
        "heading": "Questions cooks ask",
        "body": [
          {
            "text": "Is one drop always a reasonable starting amount?.",
            "sourceIds": []
          },
          {
            "text": "No fixed amount fits every product or person. Follow the label, avoid concentrated products that are unsuitable for the recipe, and consider choosing a milder sauce. The title describes controlled addition rather than free pouring; it does not establish a safe dose.",
            "sourceIds": []
          },
          {
            "text": "Can I rescue a whole pot that is too hot?.",
            "sourceIds": []
          },
          {
            "text": "You may be able to improve flavor by combining some of it with additional unseasoned food, but that is not a guarantee that everyone can comfortably eat it. Keep a separate mild meal available and do not pressure guests to eat a rescue attempt. Discard food when ingredient or handling safety is uncertain.",
            "sourceIds": []
          },
          {
            "text": "What should I write in my recipe notes?.",
            "sourceIds": []
          },
          {
            "text": "Record the sauce brand and variety, the amount used, the quantity of food, when it was added, and the preference of the people who chose to taste it. Avoid turning another person's discomfort into a rating or competition.",
            "sourceIds": []
          }
        ]
      },
      {
        "heading": "Make the next meal easy to opt into",
        "body": [
          {
            "text": "Choose a familiar mild recipe, place the labeled sauce beside clean serving utensils, and prepare one separate optional portion. The Flameathon resource library offers more ideas for flavor-focused gatherings. Food safety, allergen needs, capsaicin tolerance, and a comfortable opt-out should remain part of the plan from preparation through leftovers.",
            "sourceIds": []
          }
        ]
      }
    ...
    "table": {
      "caption": "Use a serving decision table",
      "columns": [
        "Situation",
        "Practical choice",
      ...
      "rows": [
        [
          "Guests have mixed heat preferences",
          "Keep the main dish mild and sauce separate",
          "Name the sauce and make declining easy"
        ],
        [
          "A new bottle has unfamiliar strength",
          "Evaluate a small separate portion",
          "Explain that the recipe is being tested"
        ],
        [
          "Ingredient or allergen information is unclear",
          "Do not serve it to someone who needs that information",
          "Preserve the label and choose an alternative"
        ],
        [
          "Sauce spills or irritates skin or eyes",
          "Stop preparation and seek appropriate exposure guidance",
          "Tell helpers what product was involved"
        ],
        [
          "A guest becomes uncomfortable",
          "Stop the tasting; do not encourage another bite",
          "Offer space and assistance without pressure"
        ]
      ]
    },
    "sourceIds": [
