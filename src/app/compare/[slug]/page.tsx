      ...
      <div className="mx-auto max-w-5xl px-5 py-10">
        ...
        <section className="mt-8 rounded-lg border border-[#dce5dc] bg-white p-6 shadow-sm">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <Link href="/resources/topics/hot-sauce-challenge-sets" className="inline-flex min-h-11 items-center gap-2 rounded-md border border-[#cbd8cf] px-4 py-2 text-sm font-black hover:border-[#0e7a5f]">
              Tasting guide
