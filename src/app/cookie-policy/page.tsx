...
export const metadata: Metadata = {
  title: "Cookie Policy",
  description: "Cookie Policy for Flamathon, including analytics, affiliate links, and browser choices.",
  alternates: { canonical: "/cookie-policy" },
};

const sections = [
  { title: "How cookies may be used", body: "Flamathon may use cookies, pixels, log files, analytics tools, affiliate tracking, and similar technologies to operate the site, understand performance, remember basic preferences, and attribute qualifying purchases." },
  { title: "Affiliate links", body: "When you click an affiliate link, Amazon or another third-party retailer may use cookies or similar technologies under its own policies. Flamathon does not control those third-party tracking systems." },
