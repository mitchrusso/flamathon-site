...
export const metadata: Metadata = {
  title: "Spicy Food Buying FAQ",
  description:
    "Answers to common questions about Flamathon, spicy food safety reviews, affiliate links, safety guidance, and online buying decisions.",
  alternates: {
    canonical: "/faq",
  },
};
  ...
  return (
    <main className="min-h-screen bg-[#f3f4f6] px-5 py-16 text-[#18211f]">
      ...
      <article className="mx-auto max-w-4xl rounded-lg bg-white p-8 shadow-sm sm:p-12">
        ...
        <h1 className="mt-8 text-4xl font-black">Spicy Food Buying FAQ</h1>
        <p className="mt-6 text-base leading-8 text-[#5d6d66]">
          Quick answers about using Flamathon, comparing hot sauce and spicy food categories, affiliate links, labels, heat levels, and safer tasting considerations.
        </p>
